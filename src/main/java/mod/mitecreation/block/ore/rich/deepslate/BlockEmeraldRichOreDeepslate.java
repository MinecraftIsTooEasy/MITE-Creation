...
public class BlockEmeraldRichOreDeepslate extends BlockRichOreDeepslate {
    public static final String[] RICH_ORE_TEXTURE_TYPES = new String[]{"deepslate", "deepslate"};
    public static Icon[] RICH_ORE_ICONS;

    public BlockEmeraldRichOreDeepslate(int par1, Material vein_material, int min_harvest_level) {
