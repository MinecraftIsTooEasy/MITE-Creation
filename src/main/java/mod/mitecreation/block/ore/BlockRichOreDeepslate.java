...
public class BlockRichOreDeepslate extends BlockOre implements IBlockWithSubtypes {
    ...
    public BlockSubtypes subtypes = new BlockSubtypes(new String[] {"deepslate_rich", "deepslate_rich"});

    public BlockRichOreDeepslate(int par1, Material vein_material, int min_harvest_level) {
