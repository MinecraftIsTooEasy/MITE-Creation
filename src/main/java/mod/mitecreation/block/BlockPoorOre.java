...
public class BlockPoorOre extends BlockOre implements IBlockWithSubtypes {
    public Material vein_material;
    public static final String[] POOR_ORE_TEXTURE_TYPES = new String[]{null, null, "deepslate", "deepslate"};
    public static Icon[] POOR_ORE_ICONS;
    public BlockSubtypes subtypes = new BlockSubtypes(new String[] {"poor", "poor", "deepslate_poor", "deepslate_poor"});

    public BlockPoorOre(int par1, Material vein_material, int min_harvest_level) {
    ...
    public String getMetadataNotes() {
        return "0=Natural, 1=Placed, 2=Deepslate natural, 3=Deepslate natural";
    }
    ...
    public boolean isDeepslate(int metadata) {
        return metadata > 1;
    }
    ...
    public float getBlockHardness(int metadata) {
        return switch (metadata) {
            case 0, 1 -> super.getBlockHardness(metadata) * 0.7F;
            case 2, 3 -> super.getBlockHardness(metadata) * 0.7F * 1.25F;
            default -> super.getBlockHardness(metadata);
        };
    }
