...
public class EntityCTSpirit extends EntityMob {
    ...
    public EntityCTSpirit(World par1World) {
        super(par1World);
    ...
    public EntityItem findTargetEntityItem(float max_distance) {
        Iterator i = this.worldObj.getEntitiesWithinAABB(EntityItem.class, this.boundingBox.expand(max_distance, (max_distance * 0.25F), max_distance)).iterator();
    ...
    protected String getLivingSound() {
        return this.isScreaming() ? CTSounds.spiritScream.toString() : CTSounds.spiritIdle.toString();
    }

    protected String getHurtSound() {
        return CTSounds.spiritHit.toString();
    }

    protected String getDeathSound() {
        return CTSounds.spiritDeath.toString();
    }
