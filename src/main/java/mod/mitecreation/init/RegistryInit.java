...
import mod.mitecreation.client.gui.CreativeTabsCreationBlock;
import mod.mitecreation.client.gui.CreativeTabsCreationItem;
import mod.mitecreation.client.gui.CreativeTabsCreationTool;
...
import static net.minecraft.Block.soundMetalFootstep;
import static net.minecraft.Block.soundSandFootstep;
...
public class RegistryInit implements IGameRegistry {
    ...
    public static Block rustedIronBlock = null;
    ...
    public static CreationItemFishingRod fishingRodRustedIron = (CreationItemFishingRod)(new CreationItemFishingRod(IdUtil.getNextItemID(), CreationMaterial.rusted_iron)).setUnlocalizedName("fishingRod").setCreativeTab(tabCreationTool);
    ...
    public static final ItemRawNugget rawTungstenNugget = (ItemRawNugget) new ItemRawNugget(IdUtil.getNextItemID(), CreationMaterial.tungsten).setCreativeTab(tabCreationItem);
    ...
    public static final ItemNugget tungstenNugget = (ItemNugget) createInstance(ItemNugget.class, new Class[]{int.class,Material.class},IdUtil.getNextItemID(), CreationMaterial.tungsten).setCreativeTab(tabCreationItem);
    public static final Item ingotTungsten = createInstance(ItemIngot.class,new Class[]{int.class,Material.class},IdUtil.getNextItemID(), CreationMaterial.tungsten).setXPReward(25).setCreativeTab(tabCreationItem);

    public static final ItemWarHammer warHammerTungsten = (ItemWarHammer) createInstance(ItemWarHammer.class,new Class[]{int.class,Material.class},IdUtil.getNextItemID(), CreationMaterial.tungsten).setCreativeTab(tabCreationTool);
    public static final ItemBattleAxe battleAxeTungsten = (ItemBattleAxe) createInstance(ItemBattleAxe.class,new Class[]{int.class,Material.class},IdUtil.getNextItemID(), CreationMaterial.tungsten).setCreativeTab(tabCreationTool);
    public static final ItemSword swordTungsten = (ItemSword) createInstance(ItemSword.class,new Class[]{int.class,Material.class},IdUtil.getNextItemID(), CreationMaterial.tungsten).setCreativeTab(tabCreationTool);
    public static final ItemDagger daggerTungsten = (ItemDagger) createInstance(ItemDagger.class,new Class[]{int.class,Material.class},IdUtil.getNextItemID(), CreationMaterial.tungsten).setCreativeTab(tabCreationTool);
    public static final ItemPickaxe pickaxeTungsten = (ItemPickaxe) createInstance(ItemPickaxe.class,new Class[]{int.class,Material.class},IdUtil.getNextItemID(), CreationMaterial.tungsten).setCreativeTab(tabCreationTool);
    public static final ItemShovel shovelTungsten = (ItemShovel) createInstance(ItemShovel.class,new Class[]{int.class,Material.class},IdUtil.getNextItemID(), CreationMaterial.tungsten).setCreativeTab(tabCreationTool);
    public static final ItemAxe axeTungsten = (ItemAxe) createInstance(ItemAxe.class,new Class[]{int.class,Material.class},IdUtil.getNextItemID(), CreationMaterial.tungsten).setCreativeTab(tabCreationTool);
    public static final ItemHoe hoeTungsten = (ItemHoe) createInstance(ItemHoe.class,new Class[]{int.class,Material.class},IdUtil.getNextItemID(), CreationMaterial.tungsten).setCreativeTab(tabCreationTool);
    public static final ItemKnife knifeTungsten = (ItemKnife) createInstance(ItemKnife.class,new Class[]{int.class,Material.class},IdUtil.getNextItemID(), CreationMaterial.tungsten).setCreativeTab(tabCreationTool);
    public static final ItemMattock mattockTungsten = (ItemMattock) createInstance(ItemMattock.class,new Class[]{int.class,Material.class},IdUtil.getNextItemID(), CreationMaterial.tungsten).setCreativeTab(tabCreationTool);
    public static final ItemScythe scytheTungsten = (ItemScythe) createInstance(ItemScythe.class,new Class[]{int.class,Material.class},IdUtil.getNextItemID(), CreationMaterial.tungsten).setCreativeTab(tabCreationTool);
    public static final ItemShears shearsTungsten = (ItemShears) createInstance(ItemShears.class,new Class[]{int.class,Material.class},IdUtil.getNextItemID(), CreationMaterial.tungsten).setCreativeTab(tabCreationTool);
    public static final ItemHatchet hatchetTungsten = (ItemHatchet) createInstance(ItemHatchet.class,new Class[]{int.class,Material.class},IdUtil.getNextItemID(), CreationMaterial.tungsten).setCreativeTab(tabCreationTool);
    public static CreationItemFishingRod fishingRodTungsten = (CreationItemFishingRod)(new CreationItemFishingRod(IdUtil.getNextItemID(), CreationMaterial.tungsten)).setUnlocalizedName("fishingRod").setCreativeTab(tabCreationTool);

    public static final ItemArmor helmetTungsten = (ItemArmor) new ItemHelmet(IdUtil.getNextItemID(), CreationMaterial.tungsten,false).setCreativeTab(tabCreationTool);
    public static final ItemArmor helmetChainTungsten = (ItemArmor) new ItemHelmet(IdUtil.getNextItemID(), CreationMaterial.tungsten,true).setCreativeTab(tabCreationTool);
    public static final ItemArmor plateTungsten = (ItemArmor) new ItemCuirass(IdUtil.getNextItemID(), CreationMaterial.tungsten,false).setCreativeTab(tabCreationTool);
    public static final ItemArmor plateChainTungsten = (ItemArmor) new ItemCuirass(IdUtil.getNextItemID(), CreationMaterial.tungsten,true).setCreativeTab(tabCreationTool);
    public static final ItemArmor legsTungsten = (ItemArmor) new ItemLeggings(IdUtil.getNextItemID(), CreationMaterial.tungsten,false).setCreativeTab(tabCreationTool);
    public static final ItemArmor legsChainTungsten = (ItemArmor) new ItemLeggings(IdUtil.getNextItemID(), CreationMaterial.tungsten,true).setCreativeTab(tabCreationTool);
    public static final ItemArmor bootsTungsten = (ItemArmor) new ItemBoots(IdUtil.getNextItemID(), CreationMaterial.tungsten,false).setCreativeTab(tabCreationTool);
    public static final ItemArmor bootsChainTungsten = (ItemArmor) new ItemBoots(IdUtil.getNextItemID(), CreationMaterial.tungsten,true).setCreativeTab(tabCreationTool);

    public static final Item doorTungstenItem = new ItemDoor(IdUtil.getNextItemID(), CreationMaterial.tungsten).setCreativeTab(tabCreationBlock);
    public static final ItemChain chainTungsten = (ItemChain) createInstance(ItemChain.class,new Class[]{int.class,Material.class},IdUtil.getNextItemID(), CreationMaterial.tungsten).setCreativeTab(tabCreationItem);
    public static final ItemCoin coinTungsten = (ItemCoin) createInstance(ItemCoin.class, new Class[]{int.class, Material.class}, IdUtil.getNextItemID(), CreationMaterial.tungsten).setCreativeTab(tabCreationItem);
    public static final ItemArrow arrowTungsten = (ItemArrow) new ItemArrow(IdUtil.getNextItemID(), CreationMaterial.tungsten).setCreativeTab(tabCreationTool);

    public static final ItemBucket tungstenBucket = (ItemBucket) new ItemBucket(IdUtil.getNextItemID(), CreationMaterial.tungsten, null).setCreativeTab(tabCreationTool);
    public static final ItemBucket tungstenBucketWater = (ItemBucket) new ItemBucket(IdUtil.getNextItemID(), CreationMaterial.tungsten, Material.water).setContainerItem(tungstenBucket).setCreativeTab(tabCreationTool);
    public static final ItemBucket tungstenBucketLava = (ItemBucket) new ItemBucket(IdUtil.getNextItemID(), CreationMaterial.tungsten, Material.lava).setContainerItem(tungstenBucket).setCreativeTab(tabCreationTool);
    public static final ItemBucket tungstenBucketStone = (ItemBucket) new ItemBucket(IdUtil.getNextItemID(), CreationMaterial.tungsten, Material.stone).setContainerItem(tungstenBucket).setCreativeTab(tabCreationTool);
    public static final ItemBucketMilk tungstenBucketMilk = (ItemBucketMilk) (new ItemBucketMilk(IdUtil.getNextItemID(), CreationMaterial.tungsten)).setContainerItem(tungstenBucket).setCreativeTab(tabCreationTool);
...
//    public static final Item rustedIronItemBlock = new ItemBlock(rustedIronBlock).setMaxStackSize(4).setCreativeTab(tabCreationBlock);
    ...
    public static final ItemClub clubStone = (ItemClub) createInstance(ItemClub.class,new Class[]{int.class,Material.class},IdUtil.getNextItemID(), CreationMaterial.stone).setCreativeTab(tabCreationTool);
    public static final ItemDagger daggerStone = (ItemDagger) createInstance(ItemDagger.class,new Class[]{int.class,Material.class},IdUtil.getNextItemID(), CreationMaterial.stone).setCreativeTab(tabCreationTool);

    public static final ItemBucket woodBucketEmpty = (ItemBucket) new ItemBucket(IdUtil.getNextItemID(), CreationMaterial.wood,null).setCreativeTab(tabCreationTool);
    public static final ItemBucket woodBucketWater = (ItemBucket) new ItemBucket(IdUtil.getNextItemID(), CreationMaterial.wood, CreationMaterial.water).setContainerItem(woodBucketEmpty).setCreativeTab(tabCreationTool);
    public static final ItemBucketMilk woodBucketMilk = (ItemBucketMilk) new ItemBucketMilk(IdUtil.getNextItemID(), CreationMaterial.wood).setContainerItem(woodBucketEmpty).setCreativeTab(tabCreationTool);
    ...
    public static ItemHorseArmor horseArmorTungsten = (ItemHorseArmor) createInstance(ItemHorseArmor.class,new Class[]{int.class, Material.class}, IdUtil.getNextItemID(), CreationMaterial.tungsten).setCreativeTab(tabCreationTool);
...
//        registry.registerItem("rusted_iron_block", rustedIronItemBlock);
        ...
        registry.registerItem("buckets/tungsten/empty", tungstenBucket);
        ...
        registry.registerBlock(anvilRustedIron, "rusted_iron_anvil");
        anvilRustedIron.stepSound = Block.soundAnvilFootstep;
        registry.registerBlock(anvilTungsten, "tungsten_anvil");
    ...
    static {
        ...
        anvilRustedIron = (BlockAnvil) new AnvilBlock(IdUtil.getNextBlockID(), Material.rusted_iron).setCreativeTab(tabCreationBlock);
        ...
        doorTungsten = (new DoorBlock(IdUtil.getNextBlockID(), CreationMaterial.tungsten, () -> Item.getItem(RegistryInit.doorTungsten)))
                .setStepSound(soundMetalFootstep).setMinHarvestLevel(4).setCreativeTab(tabCreationBlock);

        anvilTungsten = (BlockAnvil) new AnvilBlock(IdUtil.getNextBlockID(), CreationMaterial.tungsten).setCreativeTab(tabCreationBlock);
        ...
        chestTungsten = new StrongBoxBlock(IdUtil.getNextBlockID(), CreationMaterial.tungsten).setStepSound(soundMetalFootstep).setUnlocalizedName("chestTungsten").setCreativeTab(tabCreationBlock);
    }
}
