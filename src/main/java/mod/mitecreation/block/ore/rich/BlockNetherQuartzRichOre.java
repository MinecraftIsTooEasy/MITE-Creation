package mod.mitecreation.block.ore.rich;

import mod.mitecreation.block.ore.BlockRichOre;
import net.minecraft.Icon;
import net.minecraft.IconRegister;
import net.minecraft.Material;

public class BlockNetherQuartzRichOre extends BlockRichOre {
    public static final String[] RICH_ORE_TEXTURE_TYPES = new String[]{null, null, "deepslate", "deepslate"};
    public static Icon[] RICH_ORE_ICONS;

    public BlockNetherQuartzRichOre(int par1, Material vein_material, int min_harvest_level) {
