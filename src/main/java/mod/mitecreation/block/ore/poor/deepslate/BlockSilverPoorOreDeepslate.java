...
public class BlockSilverPoorOreDeepslate extends BlockPoorOreDeepslate {
    public static final String[] POOR_ORE_TEXTURE_TYPES = new String[]{"deepslate", "deepslate"};
    public static Icon[] POOR_ORE_ICONS;

    public BlockSilverPoorOreDeepslate(int par1, Material vein_material, int min_harvest_level) {
