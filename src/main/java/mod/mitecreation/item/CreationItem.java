...
//    public static ItemHorseArmor horseArmorTungsten = createInstance(ItemHorseArmor.class,new Class[]{int.class, Material.class}, IdUtil.getNextItemID(), CreationMaterial.tungsten);
//
//
...
//
//        event.register(CreationNameSpace, "armor/horse/tungsten", horseArmorTungsten, CreativeTabs.tabMisc);
