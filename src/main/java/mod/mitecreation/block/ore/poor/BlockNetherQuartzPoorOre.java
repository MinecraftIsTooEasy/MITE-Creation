package mod.mitecreation.block.ore.poor;
...
public class BlockNetherQuartzPoorOre extends BlockPoorOre {
    ...
    public BlockNetherQuartzPoorOre(int par1, Material vein_material, int min_harvest_level) {
