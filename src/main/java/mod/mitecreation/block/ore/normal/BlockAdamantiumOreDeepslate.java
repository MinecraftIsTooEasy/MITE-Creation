...
public class BlockAdamantiumOreDeepslate extends BlockOreDeepslate {
    public static final String[] ORE_TEXTURE_TYPES = new String[]{"deepslate", "deepslate"};
    public static Icon[] ORE_ICONS;

    public BlockAdamantiumOreDeepslate(int par1, Material vein_material, int min_harvest_level) {
